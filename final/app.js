...
// all category pages
app.get("/1",(req,res)=>{
    const data = require('./data/action.json') 
    res.render('category',{data})
})
app.get("/2",(req,res)=>{
    const data = require('./data/adventure.json') 
    res.render('category',{data})
})
app.get("/3",(req,res)=>{
    const data = require('./data/rpg.json') 
    res.render('category',{data})
})
//details page
app.get("/1/details/:id",(req,res)=>{
